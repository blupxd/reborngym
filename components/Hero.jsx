...
const Hero = () => {
  ...
  return (
    <div  className="w-full relative mt-12 grid grid-cols-1 md:grid-cols-2 bg-black">
      <div style={{zIndex: 50}} className="flex md:mt-0 mt-12 flex-col justify-center p-6 md:p-12">
        <h1 className="font-extrabold md:text-left text-center text-red-700 text-6xl mb-12">
          REBORN GYM
        </h1>
        <h1 className="text-6xl md:text-4xl lg:text-6xl text-center md:text-left text-white font-extrabold">
      ...
      <Image src={slika} alt="slika" objectFit="cover" className="md:hidden block w-full opacity-20 absolute top-0"/>
    </div>
  );
};
